...
class HasilRekaan extends StatefulWidget {
  final int skorAkhir;
  ...
  @override
  State<HasilRekaan> createState() => _HasilRekaanState();
}

class _HasilRekaanState extends State<HasilRekaan> {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: Color(0xFFA8D1D1), // Warna Card Hasil Rekaan
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.25),
                  ...
                  Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: Color(0xFFA8D1D1), // Warna Card Skor Rekaan
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.25),
