...
class HasilSowara extends StatefulWidget {
  final int skorAkhir;
  ...
  @override
  State<HasilSowara> createState() => _HasilSowaraState();
}

class _HasilSowaraState extends State<HasilSowara> {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: Color(0xFFCDB699), // Warna Card Hasil Sowara
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.25),
                  ...
                  Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: Color(0xFFCDB699), // Warna Card Skor Sowara
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.25),
