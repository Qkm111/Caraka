...
// Hapus import shared_preferences jika tidak digunakan

class HasilPangangghuy extends StatefulWidget {
  final int skorAkhir;

  const HasilPangangghuy({
    super.key,
    required this.skorAkhir,
  });

  @override
  State<HasilPangangghuy> createState() => _HasilPangangghuyState();
}

class _HasilPangangghuyState extends State<HasilPangangghuy> {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: Color(0xFFFFE1AF), // Warna Card Hasil Pangangghuy
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.25),
                  ...
                  Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    decoration: BoxDecoration(
                      color: Color(0xFFFFE1AF), // Warna Card Skor Pangangghuy
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.25),
