...
import 'package:caraka/kuis_pages/hasil/hasil_raja.dart';
...
class KuisRaja extends StatefulWidget {
  ...
  @override
  State<KuisRaja> createState() => _KuisRajaState();
}

class _KuisRajaState extends State<KuisRaja> {
  ...
  void _quizSelesai() async {
    ...
    await prefs.setInt('scoreRaja', scoreRaja);
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (_) => HasilRaja(skorAkhir: scoreRaja)
      )
    );
  }
  ...
  void pickAnswer(int value) {
    ...
    final question = pertanyaanRaja[questionIndex];
  ...
  void Selanjutnya() {
    if (questionIndex < pertanyaanRaja.length - 1) {
      questionIndex++;
  ...
  Widget build(BuildContext context) {
    final tanya = pertanyaanRaja[questionIndex];
    bool isAkhir = questionIndex == pertanyaanRaja.length - 1;
