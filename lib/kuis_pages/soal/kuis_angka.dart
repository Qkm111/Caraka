...
import 'package:caraka/kuis_pages/hasil/hasil_Angka.dart';
...
class KuisAngka extends StatefulWidget {
  ...
  @override
  State<KuisAngka> createState() => _KuisAngkaState();
}

class _KuisAngkaState extends State<KuisAngka> {
  ...
  void _quizSelesai() async {
    ...
    await prefs.setInt('scoreAngka', scoreAngka);
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (_) => HasilAngka(skorAkhir: scoreAngka)
      )
    );
  }
  ...
  void pickAnswer(int value) {
    ...
    final question = pertanyaanAngka[questionIndex];
  ...
  void Selanjutnya() {
    if (questionIndex < pertanyaanAngka.length - 1) {
      questionIndex++;
  ...
  Widget build(BuildContext context) {
    final tanya = pertanyaanAngka[questionIndex];
    bool isAkhir = questionIndex == pertanyaanAngka.length - 1;
